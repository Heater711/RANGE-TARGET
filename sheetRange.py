...
def plotTargetsheet(ts, pinfo):
    ...
    if bombDistance == 0 and bombRadial == 0:
        ...
        targetImage = plt.imread('StrafeImageAlphaed.png')
        ...
        targetImage = plt.imread('rangeTargetImageCropped.png')
        plt.imshow(targetImage,interpolation='none',origin='upper',extent=[-195, 195, -195, 195], clip_on=True) #this shows the image without being able to change paramters...
        #ax.figure.figimage(targetImage, 45,170, zorder=0, alpha=.7) #lower number results in more left for x, more down for y
        #matplotlib.use('Agg')
        plt.ioff() 
        ...
        targetImage = plt.imread('NorthUp.png')
        ...
        craterImage = plt.imread('crater2.png')
        #plt.imshow(targetImage) #this shows the image without being able to change paramters...
        #ax.figure.figimage(craterImage, x,y, alpha=1, zorder=9) #lower number results in more left for x, more down for y THIS WAS WORKING BUT NOT PLACING IN CORRECT LOCATION
        ...
        targetImage = plt.imread('greenArrow.png')
...
#**** use line below on old MBP on Cranky Ca. NTTR server and comment out all others 
#targetfolder = 'C:/Users/Adam/Saved Games/DCS.openbeta_server/logs'

# **** use line below for Adam's MBP and comment out all others 
targetfolder = 'C:/Users/Administrator/Saved Games/nevada/Logs'

# **** use line below for Angry AZ on Kim's server and comment out all paths***
#targetfolder = 'C:/Users/Insurance/Saved Games/DCS.openbeta_server/logs' 
...
#targetfile = '../targetsheets/AIRBOSS-CVN74_Targetsheet-Vexx_FA-18C_hornet-0191.csv'
#targetfile = '../targetsheets/AIRBOSS-CVN74_Targetsheet-DG_441_FA-18C_hornet-0042.csv'
